...
public class Test_Automation_Cleargear_TestClass extends Base {
	boolean value;
	...
	public void VeriFy_SearchMenu() throws Throwable {
		...
		@Test(priority = 7,description = "Verify The Active module in Alert page",enabled =true)
		public void VeriFy_Activealerts_Alertpage() throws Throwable {
			value=	new POM_ClearGear(driver).verify_ClickonAlertMenu();
